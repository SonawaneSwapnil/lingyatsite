      ...
      <section className="breadcrumb-area profile-bc-area">
        <div className="container">
          <div className="content">
            <h4 className="title extra-padding">Add/Update Personal Information</h4>
                      ...
                      <form onSubmit={handleSubmit(updateRecord)}>
                        ...
                        <div className="form-group">
                          ...
                          {showhide === "Other/इतर" && (
                            <div className="form-group">
                              <label htmlFor="branch" className="ititle">Branch/शाखा</label>
                              <input type="text" className="my-form-control" name="branch" id="branch" />
                            </div>
                          )}
                        ...
                        <div className="form-group">
                          <label htmlFor="exampleInputedu" className="form-label ititle">
                        ...
                        <div className="form-group">
                          <label htmlFor="exampleInputser" className="form-label ititle">
